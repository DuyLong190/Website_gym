...
<body>
    ...
    if (isset($_SESSION['pt_id'])) {
        ...
        $ptModel = new PtModel($db);
        $pt = $ptModel->getPTById((int)$_SESSION['pt_id']);
        
        if ($pt) {
            $userName = !empty($pt->HoTen) ? htmlspecialchars($pt->HoTen) : 'Tài khoản';
            $userImage = !empty($pt->image) ? '/gym/' . htmlspecialchars($pt->image) : '/Gym/public/images/user.png';
        }
    }
    ?>
    ...
    <nav class="navbar">
        <ul class="navbar__menu">
            <li class="navbar__item">
                <a href="/gym/pt/profile" class="navbar__link"><i data-feather="user"></i><span>Thông tin cá nhân</span></a>
            </li>
            <li class="navbar__item">
                <a href="/gym/pt/lophoc" class="navbar__link"><i data-feather="calendar"></i><span>Lớp học</span></a>
            </li>
            <li class="navbar__item">
                <a href="/gym/pt/lichday" class="navbar__link"><i data-feather="clipboard"></i><span>Lịch dạy</span></a>
            </li>
            <li class="navbar__item">
                <a href="/gym/pt/lichsu" class="navbar__link"><i class="fas fa-clock-rotate-left "></i><span>Lịch sử hoạt động</span></a>
            </li>
            <li class="navbar__item">
