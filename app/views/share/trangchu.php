...
<main class="relative min-h-screen">
    ...
    <section class="py-16 sm:py-24">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-center text-text-light-primary dark:text-text-dark-primary mb-4">
                ...
                <p class="text-base md:text-lg text-center text-text-light-secondary dark:text-text-dark-secondary mb-4">
                ...
                <p class="text-base md:text-lg text-center text-text-light-secondary dark:text-text-dark-secondary">
    ...
    <div class="container py-4 mb-5">
        <div id="carouselExampleCaptions" class="carousel slide rounded-2xl shadow-2xl overflow-hidden border border-white/10" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block bg-black/40 backdrop-blur-sm rounded-lg p-6">
                        <h5 class="text-2xl font-bold mb-3 drop-shadow-lg">Chào mừng bạn đến với LD Fitness</h5>
                        <p class="text-lg drop-shadow-md">LD Fitness tin rằng mọi người, ở mọi nơi, đều nên được tiếp cận với hoạt động thể chất <br>
