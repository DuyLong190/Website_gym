            ...
            <div class="page-header">
                <h1>
                    ...
                    <div class="title-text">
                        <span class="title-main">Chi tiết dịch vụ</span>
                    </div>
                </h1>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div class="info-value">
                                        <?php echo htmlspecialchars($DVTG->ThoiGianTG, ENT_QUOTES, 'UTF-8'); ?> phút
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <div class="page-header">
                <h1>
                    ...
                    <div class="title-text">
                        <span class="title-main">Không tìm thấy dịch vụ</span>
                    </div>
                </h1>
            </div>
            <div class="card user-detail-card">
