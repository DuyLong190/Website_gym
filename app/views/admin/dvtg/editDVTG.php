        ...
        <div class="page-header">
            <h1>
                ...
                <div class="title-text">
                    <span class="title-main">Sửa thông tin dịch vụ</span>
                </div>
            </h1>
        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="TenTG" class="form-label">
                                    <i class="fas fa-tag"></i>
                                    Tên dịch vụ <span class="required-field">*</span>
                                </label>
                            ...
                            <div class="col-md-6 form-group">
                                <label for="GiaTG" class="form-label">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="ThoiGianTG" class="form-label">
                                    <i class="fas fa-clock"></i>
                                    Thời gian (phút) <span class="required-field">*</span>
                                </label>
                                <div class="input-group-icon">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group textarea-group">
                                    <label for="MoTaTG" class="form-label">
                                        <i class="fas fa-align-left"></i>
                                        Mô tả
                                    </label>
                                    <textarea name="MoTaTG" id="MoTaTG" class="form-control" rows="4" placeholder="Nhập mô tả dịch vụ"><?php echo htmlspecialchars($DVTG->MoTaTG ?? ''); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
